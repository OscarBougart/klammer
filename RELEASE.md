...
1. A German speaker has verified the bank — done for the first 130
   sentences, **open for the 112 added after the review** (and for everything
...
3. Content reaches roughly 370 sentences across tiers 1–3. Currently 242
   (tier 1: 120 — complete, tier 2: 74, tier 3: 48).
