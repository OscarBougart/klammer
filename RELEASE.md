...
1. A German speaker has verified the bank — done for the first 130
   sentences, **open for the 158 added after the review** (and for everything
...
3. Content reaches roughly 370 sentences across tiers 1–3. Currently 288
   (tier 1: 120 — complete, tier 2: 120 — complete, tier 3: 48).
